...
def get_model(opts, max_input_seq_len, input_vocab_size, max_target_seq_len, target_vocab_size):
    ...
    transformer = Transformer(max_input_seq_len, input_vocab_size, max_target_seq_len, target_vocab_size, opts)
